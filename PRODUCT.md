...
Precise, credible, understated confidence. A senior engineer's site, not a job-seeker's plea —
it reads like systems documentation that happens to be persuasive, not persuasive copy that
happens to mention systems. Three words: **technical, measured, credible.**

## Anti-references

Generic SaaS-startup portfolio templates: gradient hero text, glassmorphism-everywhere,
identical icon+heading+text card grids repeated per section, tiny uppercase tracked eyebrows
on every section, numbered 01/02/03 section markers with no real sequence behind them, a
hero-metric strip that's just decoration rather than the actual proof. This site's proof is the
case studies and the architecture diagrams — the metric strip and cards support that, they
aren't the whole pitch.
...
- The site itself is a work sample — an infra/performance engineer's portfolio being slow or
  inaccessible is an anti-signal, not a neutral flaw.
- Systems thinking shows through diagrams, not demos — most competing portfolios are
  frontend-only and lean on live demos; this one wins by showing architecture and reasoning.

## Accessibility & Inclusion

WCAG AA minimum (contrast, focus states, semantic landmarks). All motion respects
`prefers-reduced-motion` (crossfade/instant fallback, not motion removal). Fully keyboard
navigable. Responsive down to 375px, since a large share of first recruiter views are mobile.
